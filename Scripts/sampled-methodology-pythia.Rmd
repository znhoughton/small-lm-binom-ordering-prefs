...
fixef(human_data_novel_pythia_genpref_model)
fixef(human_data_attested_pythia_genpref_model)
...
fixef(human_data_novel_pythia_genpref_model_5ep)
fixef(human_data_attested_pythia_genpref_model_5ep)
...
pythia_genpref_item_preds_attested_10ep <- brm(
  log_odds ~ 1 + (1 | Alpha) + (1 | prompt),
  data   = pythia_genpref_attested_10ep,
  prior  = prior_probs,
  iter   = 20000,
  warmup = 10000,
  chains = 4,
...
fixef(human_data_novel_pythia_genpref_model_10ep)
fixef(human_data_attested_pythia_genpref_model_10ep)
